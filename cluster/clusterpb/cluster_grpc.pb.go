...
type MemberClient interface {
	...
	SwithMode(ctx context.Context, in *SwithModeRequest, opts ...grpc.CallOption) (*SwithModeResponse, error)
}
...
func (c *memberClient) Kick(ctx context.Context, in *KickRequest, opts ...grpc.CallOption) (*KickResponse, error) {
	out := new(KickResponse)
	err := c.cc.Invoke(ctx, "/clusterpb.Member/Kick", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memberClient) SwithMode(ctx context.Context, in *SwithModeRequest, opts ...grpc.CallOption) (*SwithModeResponse, error) {
	out := new(SwithModeResponse)
	err := c.cc.Invoke(ctx, "/clusterpb.Member/SwithMode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemberServer interface {
	...
	SwithMode(context.Context, *SwithModeRequest) (*SwithModeResponse, error)
}
...
func (UnimplementedMemberServer) Kick(context.Context, *KickRequest) (*KickResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Kick not implemented")
}
func (UnimplementedMemberServer) SwithMode(context.Context, *SwithModeRequest) (*SwithModeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SwithMode not implemented")
}
...
func _Member_Kick_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KickRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemberServer).Kick(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clusterpb.Member/Kick",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).Kick(ctx, req.(*KickRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Member_SwithMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SwithModeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemberServer).SwithMode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clusterpb.Member/SwithMode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemberServer).SwithMode(ctx, req.(*SwithModeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Member_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Kick",
			Handler:    _Member_Kick_Handler,
		},
		{
			MethodName: "SwithMode",
			Handler:    _Member_SwithMode_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cluster.proto",
